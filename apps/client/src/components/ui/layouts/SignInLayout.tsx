  ...
  <BaseLayout>
    <div className="grid grid-cols-12 lg:h-screen overflow-hidden">
      ...
      <div className="col-span-12 lg:col-span-5  h-full bg-no-repeat flex flex-col items-center relative">
        ...
        <div className="z-10 pt-40 py-14 relative text-paleWhite px-4 lg:px-8 pb-40  w-100 flex  flex-col justify-center items-center">
          ...
          <img className="mt-8 h-3/4 w-auto" src={taken} alt="Immersion" />
        </div>
      </div>
    </div>
  </BaseLayout>
