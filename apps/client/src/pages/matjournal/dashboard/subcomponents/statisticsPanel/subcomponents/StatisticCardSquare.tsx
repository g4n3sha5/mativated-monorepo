...
export const StatisticCardSquare = ({ type, value }: Props) => {
  ...
  return (
    <div className="flex gap-x-3 basis-[40%] md:basis-1/4 lg:basis-[48%]   overflow-hidden items-center  justify-between border-2 p-3 lg:p-5 drop-shadow-xl rounded-xl border-blue bg-chillWhite text-black  ">
