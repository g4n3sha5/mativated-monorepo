...
export const TechniquesContent = ({ setIsShownRightPanel }: Props) => {
  ...
  return (
    <div className="flex flex-col  w-full text-white pt-navHeight pl-8">
      <div className="flex w-full md:w-3/4 flex-col pl-3">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-2 flex flex-col items-center mt-8">
          ...
          <hr className="border-cyan-500 mb-4 w-1/2 pt-2" />
          <div className="flex flex-wrap flex-col justify-start gap-2 w-full">
            <h1 className="text-sm font-light text-neutral-200 -mt-2 text-center md:text-center">
